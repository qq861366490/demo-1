...
function placeholder(inputs,pcolor){
	if( 'placeholder' in document.createElement('input')){
		...
		if(!inputs.length){
			inputs.value = attr(inputs,'placeholder');
			inputs.style.color = pcolor;
			inputs.onfocus = function(){
				if(this.type != 'text') return ;
				if(attr(this,'placeholder') == this.value){
					this.value = '';
					this.style.color = '';
				}
			}
			inputs.onblur = function(){
				if(this.type != 'text') return ;
				if(this.value == ''){
					this.value = attr(this,'placeholder');
